...
<section class="product_description_area">
    <div class="container">
        ...
        <div class="tab-content" id="myTabContent">
            ...
            <button type="button" class="btn btn-danger" id="modalButton">Comment Form</button>

            <script>
                // JavaScript code to check if the session is set and show alert or form accordingly
                document.getElementById('modalButton').addEventListener('click', function () {
                    <?php if (isset($_SESSION['username'])) { ?>
                    // If session is set, show the form
                    $('#form').modal('show');
                    <?php } else { ?>
                    // If session is not set, show the alert
